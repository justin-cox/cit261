...
function renderOneHikeFull(hike) {
  ...
  item.innerHTML = ` 
        ...
        <textarea class='comment' id='text'></textarea>
...
// this needs to be done on page load so the button will already have the listener attached
function addSubmitButtonListener() {
  //console.log('Hike name is: ' + hike.name);
  let submitButton = document.getElementById('submitButton');
  submitButton.addEventListener('click', () => {
    addComment(document.getElementById('text').value)
  });
}
